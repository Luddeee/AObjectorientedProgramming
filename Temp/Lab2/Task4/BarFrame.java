...
public class BarFrame extends JFrame implements ChangeListener, MouseListener {
   ...
   public void mousePressed(MouseEvent e) {
      ...
      int graph_index = (int) Math.floor((e.getY() - 30) / 50); // calc which bar the mouse is nearest
      ...
      double graph_value_raw = (e.getX() - 7.00) * (max / ICON_WIDTH);
      double graph_value =  (int) (graph_value_raw * 100) / 100.0; // filters double to two decimals

      dataModel.update(graph_index, graph_value);
